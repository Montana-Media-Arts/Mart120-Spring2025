...
Please read the [**syllabus**]({{ site.baseurl }}/syllabus/ ) for the course in its entirety. The version on this website, as well as the one in your Canvas shell, are identical.
